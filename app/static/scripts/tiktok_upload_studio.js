...
async function generateTitles() {
    ...
    document.getElementById('resultsContainer').innerHTML = `
        <div class="loading-container premium-loading">
            ...
            <div class="loading-subtext">Generating titles and hashtags<span class="loading-dots"><span>.</span><span>.</span><span>.</span></span></div>
        </div>
    `;
...
async function cancelUpload(contentId) {
    ...
    try {
        const response = await fetch('/tiktok-upload-studio/api/cancel-upload', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
